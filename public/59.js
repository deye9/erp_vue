...
Component.options.__file = "front_end/pages/ui/Tables.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-79781e6d", Component.options)
  } else {
    hotAPI.reload("data-v-79781e6d", Component.options)
  }
  ...
  data: function data() {
    return {
      ...
      complex: {
        ...
        items: __WEBPACK_IMPORTED_MODULE_0__api_user__["a" /* Items */]
      },
      basic: {
        headers: [{
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-79781e6d", module.exports)
  }
}
